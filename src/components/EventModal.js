      ...
      <form className="bg-white rounded-lg shadow-2xl w-1/4">
        ...
        <div className="p-3">
          <div className="grid grid-cols-1/5 items-end gap-y-7">
            ...
            <label className="text-gray-600" htmlFor="appt-time">
              Begin time:
              <input
                type="time"
                name="appt-time"
              ...
              />
              <p className="border-b-2 border-gray-200 pt-4">
        ...
        <footer className="flex justify-end border-t p-3 mt-5">
          <p className="text-xs flex-1 text-xs text-gray-400">
            created/update at: {date.toLocaleDateString()}
          </p>
          {selectedEvent && (
            <span
              onClick={() => {
